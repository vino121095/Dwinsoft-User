            ...
            <div className="container">
              <div className="row">
                <div className="col-md-6 ">
                  <div id="bannerhead">
                    <h1 style={{ color: "white" }}>Smoke Testing</h1>
                  </div>
                </div>
          ...
          >
            ...
            <div className="row ">
              ...
              <div className="col-md-9" data-aos="fade-up" data-aos-delay="200">
                <p>
                  Validate the core functionality of your application with our
                  smoke testing services. We perform preliminary tests to
                  identify critical issues before more in-depth testing. Our
                  smoke tests ensure that essential features work as expected,
                  allowing for early detection of major defects. This initial
                  check helps you catch significant issues early in the
                  development process.{" "}
                </p>
              </div>
            </div>
