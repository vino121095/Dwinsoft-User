...
<div className='row' >
  ...
  <div className="image-overlay" style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", backgroundImage: "url('/Image/service1.jpg')", backgroundSize: "cover", backgroundPosition: "center", zIndex: -1 }}></div>
    ...
    <div className='col-md-6 '>
      ...
      <div id='bannerhead'>
      <h1 style={{color:'white'}}>Automation Testing</h1>
...
<h2 >Automation Testing</h2>
    ...
    <p>At Dwinsoft Technologies, our Automation Testing Services are designed to enhance the efficiency and accuracy of your software testing processes. We leverage state-of-the-art automation tools and frameworks to streamline repetitive testing tasks, enabling faster feedback and quicker time-to-market for your applications. Our experienced team develops robust test scripts that cover functional, regression, and performance testing, ensuring that your software maintains high quality as it evolves. By integrating automation into your development lifecycle, we help reduce human error, improve test coverage, and optimize resource allocation, ultimately enhancing the reliability and performance of your systems while enabling your teams to focus on innovation and growth.
    </p>
...
<div className='container' id='sect2' style={{ 
...
<h2 style={{color:'white'}}>Let's Build Your Application!</h2>
  ...
  <div className='col-md-6 d-flex justify-content-end align-items-center' id="bannerbutton" >
 ...
 {/*3rd Module Ends */}
{/*4th Module Starts */}
<div className='col-md-12' id='sect' style={{ 
